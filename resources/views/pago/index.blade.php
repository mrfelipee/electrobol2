        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('pago.create')}}" class="btn btn-success"> <i class="fas fa-user-plus"></i> </a>
                </div>
                <div class="card-body">
                    
                    <table id="personas" class="table table-light table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>NOMBRE</th>
